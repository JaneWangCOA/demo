...
var div = dom.create("<tr><td>我是tr里的td</td></tr>");
var div2 = dom.create("<tr><td>我是tr里的td</td></tr>");
var div3 = dom.create("<tr><td>我是tr里的td</td></tr>"); // console.log(div)

dom.after(test, div);
dom.after(div, div2);
var div4 = dom.create("<div id=\"parent\" style=\"color: purple\"></div>");
dom.wrap(div, div4);
dom.wrap(div2, div4);
...
var nodeList = dom.children(dom.find('.travel')[0]);
console.log(nodeList);
dom.each(nodeList, function (item) {
  dom.style(item, {
    color: 'red'
  });
  console.log(item);
